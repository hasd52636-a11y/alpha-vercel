...
// node_modules/zhipuai/esm/index.js
var import_agentkeepalive = __toESM(require_browser());
...
var Body = class {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-NYC2E3KK.js");
...
var ZhipuAIError = class extends Error {
};
...
function printDiagnostics(...args) {
  ...
  log((0, import_util.inspect)(args, false, 10, true));
}
var readEnv = (env) => {
...
var APIError = class _APIError extends ZhipuAIError {
...
function findDoubleNewlineIndex(buffer) {
  ...
  for (let i = 0; i < buffer.length - 2; i++) {
    ...
    if (buffer[i] === cr && buffer[i + 1] === lf && i + 3 < buffer.length && buffer[i + 2] === cr && buffer[i + 3] === lf) {
      return i + 4;
    }
  }
  return -1;
...
var _LineDecoder = class _LineDecoder {
  constructor() {
    ...
    __publicField(this, "trailingCR");
    __publicField(this, "textDecoder");
    this.buffer = [];
...
__publicField(_LineDecoder, "NEWLINE_CHARS", /* @__PURE__ */ new Set(["\n", "\r"]));
__publicField(_LineDecoder, "NEWLINE_REGEXP", /\r\n|[\n\r]/g);
...
var APIPromise = class extends Promise {
  constructor(responsePromise, parseResponse = defaultParseResponse) {
    ...
    __publicField(this, "responsePromise");
    __publicField(this, "parseResponse");
    __publicField(this, "parsedPromise");
...
var APIClient = class {
  constructor({ baseURL, maxRetries = 2, timeout = 10 * 60 * 1e3, httpAgent, fetch: overridenFetch }) {
    __publicField(this, "baseURL");
    __publicField(this, "maxRetries");
    __publicField(this, "timeout");
    __publicField(this, "httpAgent");
    __publicField(this, "fetch");
    __publicField(this, "idempotencyHeader");
  ...
  async makeRequest(optionsInput, retriesRemaining) {
    ...
    if (!response.ok) {
      if (retriesRemaining && this.shouldRetry(response)) {
        ...
        printDiagnostics(`response (error; ${retryMessage2})`, response.status, url, responseHeaders);
...
var ZhipuAIAuthManger = class {
  constructor() {
    __publicField(this, "cachedToken");
    __publicField(this, "options", {
      tokenTTL: 3 * 60 * 1e3,
      tokenRefreshTTL: 30 * 1e3
    });
  }
  getToken(apiKey) {
    if (this.cachedToken && this.cachedToken.exp - this.options.tokenRefreshTTL > Date.now()) {
...
var ChatCompletionTasks = class extends APIResource {
  create(body, options) {
...
var ChatCompletions = class extends APIResource {
  constructor() {
    super(...arguments);
    __publicField(this, "tasks", new ChatCompletionTasks(this._client));
  }
  create(body, options) {
...
var Chat = class extends APIResource {
  constructor() {
    super(...arguments);
    __publicField(this, "completions", new ChatCompletions(this._client));
  }
};
...
var ZhipuAI = class extends APIClient {
  constructor({ baseURL = readEnv("ZHIPUAI_BASE_URL"), apiKey = readEnv("ZHIPUAI_API_KEY"), organization = readEnv("ZHIPUAI_ORG_ID") ?? null, project = readEnv("ZHIPUAI_PROJECT_ID") ?? null, ...opts } = {}) {
    if (apiKey === void 0) {
      throw new ZhipuAIError("The ZHIPUAI_API_KEY environment variable is missing or empty; either provide it, or instantiate the ZhipuAI client with an apiKey option, like new ZhipuAI({ apiKey: 'My API Key' }).");
    }
    const options = {
      apiKey,
      organization,
    ...
    __publicField(this, "options");
    __publicField(this, "authManager", new ZhipuAIAuthManger());
    __publicField(this, "chat", new Chat(this));
    __publicField(this, "embeddings", new Embeddings(this));
    __publicField(this, "images", new Images(this));
    this.options = options;
    this.apiKey = apiKey;
